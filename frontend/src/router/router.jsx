...
import HomeEdit from '../components/home_edit/home_edit';
import SearchMail from '../components/search_mail/search_mail';
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <RouteGuard exact={ true } path='/home/edit/profile' component={ HomeEdit } option={ inside } />
        <RouteGuard exact={ true } path='/home/search/mail' component={ SearchMail } option={ inside } />
